...
[Original PDF](../Active%20Video%20Perception%20Iterative%20Evidence%20Seeking%20for%20Agentic%20Long%20Video%20Understanding.pdf)
...
![](assets/032/paper-0003-11.png)


and represent it as 


![](assets/032/paper-0003-13.png)
...
|**In**<br>**O**<br>|**puts :**Video_V_,<br>Query_Q_,<br>Max Rounds_R_max,<br>Confidence Threshold_τ_conf<br>**utput :**Answer_A_,<br>Justification_J_,<br>Evidence List_E_,<br>History_H_<br><br> <br>|
|---|---|
...
|**6**|**if**_C_<sup>(</sup><sup>_r_)</sup> _≥τ_conf **then**|
...
(2) **LVBench** [70] is a benchmark specifically designed for long video understanding which includes 1549 multiplechoice questions across 103 hour-long videos. 

(3) **MLVU** [84] is a multi-task Long Video Understanding Benchmark for the comprehensive and in-depth evaluation of LVU. We use the multiple-choice QA samples from the MLVU test split, containing 2175 video QA samples with more than 15 minutes average video duration. 
...
FLECTOR within AVP under Gemini-2.5 [53] family (we add additional model ablation in supp.). We observe that both benchmarks benefit from stronger components, but their sensitivities differ. Across both benchmarks, the largest gains consistently come from a stronger Observer. This suggests that reliable evidence acquisition is the primary bottleneck, even for complex multi-hop reasoning queries, as effective planning and reflection depend on first locating and gathering the relevant visual evidence. The best configuration uses stronger models across all three modules, confirming that AVP’s active perception design benefits from the synergy between observation, planning, and reflection. 
...
In Fig. 3, we illustrate how AVP acquires and verifies evidence through a multi-round Plan–Observe–Reflect loop on a long video. Given the query, “In the clip where the German woman is introduced by the narrator, where can the Tomb-

<!-- Page 8 -->

![](assets/032/paper-0008-00.png)
...
- [3] Shuai Bai, Keqin Chen, Xuejing Liu, Jialin Wang, Wenbin Ge, Sibo Song, Kai Dang, Peng Wang, Shijie Wang, Jun Tang, Humen Zhong, Yuanzhi Zhu, Mingkun Yang, Zhaohai Li, Jianqiang Wan, Pengfei Wang, Wei Ding, Zheren Fu, Yiheng Xu, Jiabo Ye, Xi Zhang, Tianbao Xie, Zesen Cheng, Hang Zhang, Zhibo Yang, Haiyang Xu, and Junyang Lin. Qwen2.5vl technical report. _arXiv preprint arXiv:2502.13923_ , 2025. 
...
- [16] Chaoyou Fu, Yuhan Dai, Yongdong Luo, Lei Li, Shuhuai Ren, Renrui Zhang, Zihan Wang, Chenyu Zhou, Yunhang 

   - Shen, Mengdan Zhang, Peixian Chen, Yanwei Li, Shaohui Lin, Sirui Zhao, Ke Li, Tong Xu, Xiawu Zheng, Enhong Chen, Rongrong Ji, and Xing Sun. Video-mme: The first-ever comprehensive evaluation benchmark of multi-modal llms in video analysis, 2024. 2, 5 
...
- [27] Bin Lin, Bin Zhu, Yang Ye, Munan Ning, Peng Jin, and Li Yuan. Video-llava: Learning united visual representation by alignment before projection. _arXiv preprint arXiv:2311.10122_ , 2023. 2 
...
- [45] Xiaoqian Shen, Yunyang Xiong, Changsheng Zhao, Lemeng Wu, Jun Chen, Chenchen Zhu, Zechun Liu, Fanyi Xiao, Balakrishnan Varadarajan, Florian Bordes, Zhuang Liu, Hu Xu, 

Hyunwoo J. Kim, Bilge Soran, Raghuraman Krishnamoorthi, Mohamed Elhoseiny, and Vikas Chandra. Longvu: Spatiotemporal adaptive compression for long video-language understanding. _arXiv preprint arXiv:2410.17434_ , 2024. 2, 5, 
...
- [61] Weiyun Wang, Zhangwei Gao, Lixin Gu, Hengjun Pu, Long Cui, Xingguang Wei, Zhaoyang Liu, Linglin Jing, Shenglong

<!-- Page 11 -->

Ye, Jie Shao, et al. Internvl3.5: Advancing open-source multimodal models in versatility, reasoning, and efficiency. _arXiv preprint arXiv:2508.18265_ , 2025. 1 
...
- [81] Peiyuan Zhang, Kaichen Zhang, Bo Li, Guangtao Zeng, Jingkang Yang, Yuanhan Zhang, Ziyue Wang, Haoran Tan, Chunyuan Li, and Ziwei Liu. Long context transfer from language to vision. _arXiv preprint arXiv:2406.16852_ , 2024. 2 
...
- [87] Yuanhao Zou, Shengji Jin, Andong Deng, Youpeng Zhao, Jun Wang, and Chen Chen. A.i.r.: Enabling adaptive, iterative, and reasoning-based frame selection for video question answering, 2025. 2 

- [88] Jialong Zuo, Yongtai Deng, Lingdong Kong, Jingkang Yang, Rui Jin, Yiwei Zhang, Nong Sang, Liang Pan, Ziwei Liu, and

<!-- Page 12 -->

Changxin Gao. Videolucy: Deep memory backtracking for long video understanding. In _Advances in Neural Information Processing Systems (NeurIPS 2025)_ , 2025. 2, 3, 5, 6
...
|**Method**|**Acc. %**||**Mi**|**RA Sco**|**re**_↑_||
|---|---|---|---|---|---|---|
|||**P**|**T**|**L**|**C**|**Total**|
|OpenAI o1|43.5|0.52|0.52|_0.86_|_0.88_|0.69|
|GPT-4o|45.5|0.57|0.67|0.77|0.79|0.70|
|Gemini 2.0 Flash|53.5|**0.62**|_0.75_|0.83|0.82|_0.75_|
|Gemini 2.5 Pro|_61.8_|_0.60_|0.62|**0.97**|0.78|0.74|
|AVP (Ours)|**65.6**|**0.62**|**0.82**|**0.97**|**0.93**|**0.84**|



Table 6. Reasoning trace quality check on MINERVA. We report multiple-choice accuracy and MiRA scores normalized to be between 0 and 1. P: Perceptual Correctness, T: Temporal Localization: L: Logical Reasoning: C: Completeness. The best result is in **bold** , and the second best is in _italic_ . 
...
|DVD|**73.4**|_73.3_|**80.4**|_72.3_|**70.7**|_74.1_|_74.2_|
|**AVP (Ours)**|_71.9_|**76.7**|_80.1_|**73.6**|_67.7_|**75.9**|**74.8**|



Table 7. **Results by question type on LVBench.** We report performance across six official LVBench splits: _Entity Recognition (ER)_ , _Event Understanding (EU)_ , _Key Information Retrieval (KIR)_ , _Temporal Grounding (TG)_ , _Reasoning (Rea)_ , and _Summarization (Sum)_ . Accuracy (%) is computed as Correct / Total for each split. 
...
|---|---|---|---|---|
|Long Split Acc. (%)_↑_|61.2|66.8|67.3|**76.8**|
|Inference Time (s)_↓_|145.4|442.2|612.8|**102.3**|
...
**Extended Component Ablation.** To verify that each component’s contribution generalizes beyond the Gemini backbone, we repeat the component ablation (Tab. 3) using OpenAIo3 on MINERVA. Using only the Observer achieves 54.2% accuracy; adding the Planner yields a 3.2% improvement, and incorporating the Reflector provides a further 1.6% gain. 
...
These additive improvements are consistent with the Geminibased results in Tab. 3, confirming that each AVP component contributes meaningfully regardless of the backbone MLLM. 

### **B.4. Amortized Multi-Query Efficiency** 

One potential advantage of caption-based methods is that the video-level database can be reused across multiple queries for the same video, amortizing the construction cost. We evaluate this on LVBench under a multi-query setting (avg. 15 queries/video). DeepVideoDiscovery spends 637 _._ 2 s on database construction and an additional 2329 _._ 5 s on perquery localization and answering across all queries. By skipping the captioning stage entirely, AVP answers all queries in 2179 _._ 5 s, achieving a **26.5% reduction** in total inference time even in this setting favorable to database-reuse methods. This result confirms that the efficiency gains of active, query-driven perception hold not only per-query but also in amortized multi-query scenarios. 

### **B.5. Token Efficiency Across Backbones** 

AVP’s token efficiency arises from how it adaptively plans for temporal and spatial token usage, rather than backbonespecific visual compression. Under the same OpenAI-o3
...
bar graphics and rapid scoring plays). We further analyze 50 randomly sampled LVBench failures, categorizing errors into _planner_ , _observer_ , and _reflector_ . Only 8% and 16% of errors stem from planning and reflection, while most arise from observer perception errors (76%). This verifies the AVP’s planner and reflector are relatively robust. 
...
**Function.** get_planning_prompt(query, video_meta, options). **Goal.** You are an expert video analysis planner. Create a concise, observation plan to answer the user’s query. **Inputs.** 
...
- **Where:** temporal span to examine, either _uniform_ (entire video) or a specific time range. 
...
- Factual: use the _exact_ range, no padding (e.g., “07:15–07:18” _→_ [435.0, 438.0]). 

- Reasoning: add 15–30 s padding before and after (e.g., “07:15–07:18” _→_ [420.0, 453.0]). 

- **Rule 2 (Single timestamp).** 

- Factual: 1 s forward window from timestamp (e.g., “at 02:15” _→_ [135.0, 136.0]). 

- Reasoning: add 15–30 s context (e.g., “at 02:15” _→_ [120.0, 150.0]). 

- **Rule 3 (Approximate / vague timing).** Use a _±_ 15 s window around the mentioned time (e.g., “around 1:23” _→_ [68.0, 98.0]). 

##### **Heuristics for unknown timing.** 

### **C.2. Failure Case** 

- “opening / beginning” _→_ [0, 30]. 

- “end / ending” _→_ [max(0, duration - 30), duration]. 

In Fig. 5, we analyze a representative failure mode of AVP on a fine-grained counting query. To save computation, the planner opts for a coarse 0.5 FPS scan of the entire video and the observer only records two three-point plays before the second Hawaii–UCSB clip. Since the missing shot at 00:20 is never observed, the reflector receives a logically consistent but incomplete evidence list and confidently outputs the wrong answer. This case illustrates that, while our active perception pipeline is effective for locating dispersed, highlevel evidence, it might make mistakes on questions that hinge on short, local events and subtle broadcast cues (e.g., 
...
- **Uniform scan (timing unknown).** load_mode = "uniform", fps in 0.25–1.0, spatial_token_rate _∈_ {"low", "medium"}, regions = []. 

- **Region analysis (explicit timestamps).** load_mode = "region", fps _≈_ 2.0, spatial_token_rate _∈_ {"low", "medium"}, regions = [[start, end]]. 
...
![](assets/032/paper-0016-00.png)


<!-- Start of picture text -->
Query: After adding up all the millimeter totals on the sheet of paper illustrated at the timestamp 09:58, and then adding the average length of Louisiana<br>Pine Snake hatchlings according to the video, how many total millimeters are there?<br>A. 2,217.41mm-4,130.04mm. B. 1,263.41mm-2,217.41mm. C. 693.41mm-1,912.63mm.<br>D. 1,912.63mm-2,217.41mm. E. 4,130.04mm-4,530.04mm.<br>Round 1<br>Plan<br>[09:58, 09:59]: A close-up of a<br>What : extract the millimeter totals  handwritten sheet of paper listing  Confidence : 0.3<br>from the sheet of paper at 09:58 and  measurements for seven Louisiana  Justification : Need<br>find the average length of Louisiana  Pine Snake eggs. The millimeter  additional information<br>Pine Snake hatchlings. totals listed are: 96.74, 93.37,  about average length of<br>Where : [09:58, 09:59] 93.45, 98.24, 99.53, 115.67, and  Louisiana Pine Snake<br>How : 2FPS, Medium spatial resolution  Observe 96.41. Reflect hatchlings<br>Evidence<br>History (P, E, J)<br>Round 2<br>Re-Plan Confidence : 0.7<br>Justification : Lower bound:<br>[Previous Evidence] 693.41 mm + 1219.2 mm =<br>What : Perform a uniform scan of the  [17:47, 17:50]: The narrator states  1912.61 mm - Upper bound: 693.41 mm + 1524 mm =<br>entire video to find the 'average length of  that the Louisiana Pine Snakes<br>2217.41 mm<br>Louisiana Pine Snake hatchlings'. 'usually range from 4 to 5 feet in<br>Where:  whole video length. Reflect The calculated total range is 1912.61 mm to 2217.41<br>How : 0.5FPS, low spatial resolution  Observe<br>mm. This corresponds to<br>option  D .<br><!-- End of picture text -->
...
- plans: what _∈_ sub_query, where _∈_ {"uniform", "region"}, how _∈_ numeric fps (0.1–5.0), spatial_token_rate _∈_ {"low", "medium"}, and regions (list of [start, end] in seconds; empty for uniform). 


![](assets/032/paper-0016-03.png)


<!-- Start of picture text -->
Observer prompt (video inference / evidence extraction)<br><!-- End of picture text -->


![](assets/032/paper-0016-04.png)


<!-- Start of picture text -->
Goal. Analyze a specific video segment and extract precise, time-<br>stamped evidence relevant to the user query.<br><!-- End of picture text -->


![](assets/032/paper-0016-05.png)
...
- List _all_ relevant intervals for events that may match the query. 

- Use context to avoid redundant descriptions. 


![](assets/032/paper-0016-21.png)


<!-- Start of picture text -->
Multiple-clip handling.<br><!-- End of picture text -->
...
- **Fallback rule (critical).** If analyzing a _region_ and no relevant information is present: 
...
![](assets/032/paper-0017-00.png)


<!-- Start of picture text -->
How many three-pointers are made before the second clip of Hawaii versus UCSB?        A. 3. B. 1.    C. 5.    D. 2.   E. 0.<br>What : Scan the entire video to locate  [0:04, 0:09]: First clip of Hawaii vs UCSB. A<br>three-pointer is made.<br>the start of the 'second clip' and count<br>[0:27, 0:33]: Clip of Hawaii vs Cal Poly. A three-<br>the number of three-pointers made<br>pointer is made.<br>before that point.<br>Where : entire video [0:33, 0:37]: The start of the second clip of<br>Planner How : 0.5FPS, low spatial resolution  Observer Hawaii vs UCSB, showing a steal.<br>Ground Truth Reasoning:  I looked for the first<br>USCB clip, which shows up from 00:04 to 00:08. I  Confidence :  0.8<br>knew it to be so because the names \"USCB\"  Justification : The evidence from the<br>and \"HAWAII\" are written on the bar graphic at  observation rounds clearly identifies two<br>the bottom of the screen. Then I notice the  successful three-point shots made before the<br>second clip against UCSB happens from 00:33 to  second clip of the Hawaii versus UCSB game.<br>00:37 (identified by the same logic as I identified  The first three-pointer occurs in the first clip of<br>by the first). I then looked at every clip prior to this  the video (against UCSB) from 0:04 to 0:09. The<br>timeframe and looked for three-pointers. I found  second three-pointer is made during a clip<br>1 at 00:07, another at 00:20, and another at  against Cal Poly, from 0:27 to 0:33. The second<br>00:33. Counting these up, I found 3 three- Reflector clip featuring the Hawaii vs. UCSB game begins<br>pointers made prior to the second clip of Hawaii  immediately after, at 0:33. Therefore, counting<br>vs. USCB. the shots before this point results in total of two.<br><!-- End of picture text -->
...
![](assets/032/paper-0017-02.png)


<!-- Start of picture text -->
"detailed_response": "...",<br>"key_evidence": [<br>{<br>"timestamp_start": <number>,<br>"timestamp_end": <number>,<br>"description": "..."<br>}<br>],<br>"reasoning": "..."<br>}<br>Example. [Few_examples]<br><!-- End of picture text -->
...
Inputs.<br><!-- End of picture text -->
   ...
   - Output a calibrated confidence _C ∈_ [0 _,_ 1] for the sufficiency decision. This is the score compared against _τ_ conf in Algorithm 1: as a guideline, _C ≥_ 0 _._ 7 when the evidence clearly entails an answer, 0 _._ 4 _≤ C <_ 0 _._ 7 when it is suggestive but incomplete, and _C <_ 0 _._ 4 when the key cues are unaddressed. 

   - **If sufficient (true):** the justification must give the _direct answer_ . **–** MCQ: state the option letter (A/B/C/...) and a brief reason. **–** Open-ended: clearly state the answer in natural language. 
...
"sufficient": <true | false>, "confidence": <float in [0, 1]>, "justification": "...", "reasoning": "..." } **Few-shot examples.** [Few_examples]
